  ...
  return (
    <>
      {isPhone ? (
        ...
        <header
          className={`w-full h-30 fixed flex bg-navbar items-center top-0 z-30 px-15 ${
            isScrolled ? "shadow-md" : " shadow-none"
          }`}
        >
          <nav className="flex justify-between w-full">
            <h1 className="font-heading text-navbar-fg text-5xl">
              TQ
              <span className="font-heading text-2xl text-navbar-aksen">
                Code
              </span>
            </h1>
