...
type FormInputs = {
  userName: string;
  userEmail: string;
  projectType: 'Rest API Development' | 'Prototype Design' | 'CLI Development / Automation';
  message: string;
};
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          >
            ...
            <option value="Rest API Development">1. Rest API Development</option>
            <option value="Prototype Design">2. Prototype Design</option>
            <option value="CLI Development / Automation">3. CLI Development / Automation</option>
          </select>
        ...
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4  transition duration-200 disabled:bg-blue-300"
        >
