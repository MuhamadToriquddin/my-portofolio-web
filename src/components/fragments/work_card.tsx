...
function WorkCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/20 backdrop-blur-xs opacity-100 group-hover:opacity-100 transition-all duration-300"></div>

      {/* 3. Konten Teks */}
      <div className="absolute left-5 bottom-5 space-y-3 w-[600px] z-10">
        <h5 className="font-heading text-xl md:text-7xl group-hover:text-blue-500 text-white transition-all duration-500 drop-shadow-md">
          {title}
        </h5>
